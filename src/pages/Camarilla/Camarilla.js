      ...
      <ol>
        <li>
          <div className="list-item">
            ...
            <p>
              ...
              przestrzegania prawa Camarilli i utrzymuje porządek w społeczności
              Kindredów.
            </p>
          </div>
        </li>
        ...
        <li>
          <div className="list-item">
            ...
            <p>
              ...
              zachować równowagę i jedność w społeczności Kindredów.
            </p>
          </div>
        </li>
        ...
        <li>
          <div className="list-item">
            ...
            <p>
              ...
              Kindredów. Szeryf nadzoruje przestrzeganie porządku, ściga wrogów
              Camarilli i egzekwuje sankcje wobec tych, którzy stwarzają
        ...
        <li>
          <div className="list-item">
            <h2>Harpy</h2>
            <p>
              Harpy to postacie odpowiedzialne za sprawy towarzyskie i rozgłos w
              społeczności Kindredów. Monitorują plotki, reputację i wpływy
        ...
        <li>
          <div className="list-item">
            ...
            <p>
              ...
              utrzymanie bezpieczeństwa w Sztokholmie. Patrolują obszar miasta,
              pilnują granic i reagują na zagrożenia. Strażnicy są
